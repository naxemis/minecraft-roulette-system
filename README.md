...
<<<<<<< HEAD
## To-Do
- Rewrite Electron application to Flutter
...
<<<<<<< HEAD
>>>>>>> 1055c93 (chore(readme): add todo list)
=======
>>>>>>> 2887108 (chore(readme): separate readability and maintainability of code into different todos)
